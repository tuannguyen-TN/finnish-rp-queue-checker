...
curl 'https://networkmigri.boost.ai/api/chat/v2' \
  ...
  --data-raw "{\"command\":\"POST\",\"type\":\"text\",\"value\":\"$1\",\"conversation_id\":\"Px17Uj9vPcT--dhmfMZliN7xjM0UHQThlwUUGo1vjVpdlM63uBSgkvexQXSHgh0S-YUJ9S6FxAPz5cxSLegIoA==\",\"filter_values\":[\"migri\",\"english_start_language\"],\"client_timezone\":\"Europe/Helsinki\"}" \
  --compressed
